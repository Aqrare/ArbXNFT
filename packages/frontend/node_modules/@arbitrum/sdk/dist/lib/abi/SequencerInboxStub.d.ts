...
export interface SequencerInboxStubInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "dasKeySetInfo", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "getKeysetCreationBlock", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "inboxAccs", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "initialize", values: [string, ISequencerInbox.MaxTimeVariationStruct]): string;
    encodeFunctionData(functionFragment: "invalidateKeysetHash", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "isBatchPoster", values: [string]): string;
    encodeFunctionData(functionFragment: "isValidKeysetHash", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "setValidKeyset", values: [BytesLike]): string;
...
export declare type InvalidateKeysetEvent = TypedEvent<[
    string
], {
    keysetHash: string;
}>;
export declare type InvalidateKeysetEventFilter = TypedEventFilter<InvalidateKeysetEvent>;
...
export declare type SetValidKeysetEvent = TypedEvent<[
    string,
    string
], {
    keysetHash: string;
...
export declare type SetValidKeysetEventFilter = TypedEventFilter<SetValidKeysetEvent>;
export interface SequencerInboxStub extends BaseContract {
    ...
    functions: {
        ...
        getKeysetCreationBlock(ksHash: BytesLike, overrides?: CallOverrides): Promise<[BigNumber]>;
        inboxAccs(index: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        initialize(bridge_: string, maxTimeVariation_: ISequencerInbox.MaxTimeVariationStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        invalidateKeysetHash(ksHash: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        isBatchPoster(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
        isValidKeysetHash(ksHash: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        setValidKeyset(keysetBytes: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getKeysetCreationBlock(ksHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        inboxAccs(index: BigNumberish, overrides?: CallOverrides): Promise<string>;
        initialize(bridge_: string, maxTimeVariation_: ISequencerInbox.MaxTimeVariationStruct, overrides?: CallOverrides): Promise<void>;
        invalidateKeysetHash(ksHash: BytesLike, overrides?: CallOverrides): Promise<void>;
        isBatchPoster(arg0: string, overrides?: CallOverrides): Promise<boolean>;
        isValidKeysetHash(ksHash: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        maxTimeVariation(overrides?: CallOverrides): Promise<[
            BigNumber,
        ...
        setValidKeyset(keysetBytes: BytesLike, overrides?: CallOverrides): Promise<void>;
        totalDelayedMessagesRead(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
        ...
        "InvalidateKeyset(bytes32)"(keysetHash?: BytesLike | null): InvalidateKeysetEventFilter;
        InvalidateKeyset(keysetHash?: BytesLike | null): InvalidateKeysetEventFilter;
        ...
        "SetValidKeyset(bytes32,bytes)"(keysetHash?: BytesLike | null, keysetBytes?: null): SetValidKeysetEventFilter;
        SetValidKeyset(keysetHash?: BytesLike | null, keysetBytes?: null): SetValidKeysetEventFilter;
    };
    estimateGas: {
        ...
        dasKeySetInfo(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        forceInclusion(_totalDelayedMessagesRead: BigNumberish, kind: BigNumberish, l1BlockAndTime: [BigNumberish, BigNumberish], baseFeeL1: BigNumberish, sender: string, messageDataHash: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        getKeysetCreationBlock(ksHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        isValidKeysetHash(ksHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        dasKeySetInfo(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        forceInclusion(_totalDelayedMessagesRead: BigNumberish, kind: BigNumberish, l1BlockAndTime: [BigNumberish, BigNumberish], baseFeeL1: BigNumberish, sender: string, messageDataHash: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        getKeysetCreationBlock(ksHash: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        isValidKeysetHash(ksHash: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
