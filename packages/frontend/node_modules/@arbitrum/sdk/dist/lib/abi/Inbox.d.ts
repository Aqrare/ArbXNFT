...
export declare type AllowListAddressSetEvent = TypedEvent<[
    string,
    boolean
], {
    user: string;
...
export declare type AllowListAddressSetEventFilter = TypedEventFilter<AllowListAddressSetEvent>;
export declare type AllowListEnabledUpdatedEvent = TypedEvent<[
    boolean
], {
    isEnabled: boolean;
}>;
export declare type AllowListEnabledUpdatedEventFilter = TypedEventFilter<AllowListEnabledUpdatedEvent>;
