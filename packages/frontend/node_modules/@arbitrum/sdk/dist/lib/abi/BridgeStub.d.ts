...
export interface BridgeStubInterface extends utils.Interface {
    ...
    functions: {
        ...
        "enqueueSequencerMessage(bytes32,uint256)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "enqueueSequencerMessage", values: [BytesLike, BigNumberish]): string;
...
export declare type SequencerInboxUpdatedEvent = TypedEvent<[
    string
], {
    newSequencerInbox: string;
}>;
export declare type SequencerInboxUpdatedEventFilter = TypedEventFilter<SequencerInboxUpdatedEvent>;
export interface BridgeStub extends BaseContract {
    ...
    functions: {
        ...
        enqueueSequencerMessage(dataHash: BytesLike, afterDelayedMessagesRead: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        executeCall(arg0: string, arg1: BigNumberish, arg2: BytesLike, overrides?: CallOverrides): Promise<[boolean, string]>;
        ...
        setOutbox(arg0: string, arg1: boolean, overrides?: CallOverrides): Promise<[void]>;
        setSequencerInbox(_sequencerInbox: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        submitBatchSpendingReport(batchPoster: string, dataHash: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    acceptFundsFromOldBridge(overrides?: PayableOverrides & {
    ...
    callStatic: {
        ...
        enqueueSequencerMessage(dataHash: BytesLike, afterDelayedMessagesRead: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            string,
            string,
            string
        ...
        submitBatchSpendingReport(batchPoster: string, dataHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        allowedOutboxes(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        executeCall(arg0: string, arg1: BigNumberish, arg2: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setOutbox(arg0: string, arg1: boolean, overrides?: CallOverrides): Promise<BigNumber>;
        setSequencerInbox(_sequencerInbox: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        submitBatchSpendingReport(batchPoster: string, dataHash: BytesLike, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        allowedOutboxes(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        executeCall(arg0: string, arg1: BigNumberish, arg2: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        setOutbox(arg0: string, arg1: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        setSequencerInbox(_sequencerInbox: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        submitBatchSpendingReport(batchPoster: string, dataHash: BytesLike, overrides?: Overrides & {
