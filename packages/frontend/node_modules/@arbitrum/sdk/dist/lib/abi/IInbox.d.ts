...
export interface IInbox extends BaseContract {
    ...
    functions: {
        ...
        createRetryableTicket(to: string, arbTxCallValue: BigNumberish, maxSubmissionCost: BigNumberish, submissionRefundAddress: string, valueRefundAddress: string, gasLimit: BigNumberish, maxFeePerGas: BigNumberish, data: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "depositEth(uint256)"(maxSubmissionCost: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        unsafeCreateRetryableTicket(to: string, arbTxCallValue: BigNumberish, maxSubmissionCost: BigNumberish, submissionRefundAddress: string, valueRefundAddress: string, gasLimit: BigNumberish, maxFeePerGas: BigNumberish, data: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    bridge(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        bridge(overrides?: CallOverrides): Promise<string>;
        createRetryableTicket(to: string, arbTxCallValue: BigNumberish, maxSubmissionCost: BigNumberish, submissionRefundAddress: string, valueRefundAddress: string, gasLimit: BigNumberish, maxFeePerGas: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        "depositEth(uint256)"(maxSubmissionCost: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        unsafeCreateRetryableTicket(to: string, arbTxCallValue: BigNumberish, maxSubmissionCost: BigNumberish, submissionRefundAddress: string, valueRefundAddress: string, gasLimit: BigNumberish, maxFeePerGas: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
