...
export interface RollupAdminLogicInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "createNitroMigrationGenesis", values: [RollupLib.AssertionStruct]): string;
    ...
    encodeFunctionData(functionFragment: "forceCreateNode", values: [BigNumberish, BigNumberish, RollupLib.AssertionStruct, BytesLike]): string;
...
export interface RollupAdminLogic extends BaseContract {
    ...
    functions: {
        ...
        createNitroMigrationGenesis(assertion: RollupLib.AssertionStruct, overrides?: Overrides & {
        ...
        forceCreateNode(prevNode: BigNumberish, prevNodeInboxMaxCount: BigNumberish, assertion: RollupLib.AssertionStruct, expectedNodeHash: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        challengeManager(overrides?: CallOverrides): Promise<string>;
        confirmPeriodBlocks(overrides?: CallOverrides): Promise<BigNumber>;
        createNitroMigrationGenesis(assertion: RollupLib.AssertionStruct, overrides?: CallOverrides): Promise<void>;
        currentChallenge(staker: string, overrides?: CallOverrides): Promise<BigNumber>;
        extraChallengeTimeBlocks(overrides?: CallOverrides): Promise<BigNumber>;
        firstUnresolvedNode(overrides?: CallOverrides): Promise<BigNumber>;
        forceConfirmNode(nodeNum: BigNumberish, blockHash: BytesLike, sendRoot: BytesLike, overrides?: CallOverrides): Promise<void>;
        forceCreateNode(prevNode: BigNumberish, prevNodeInboxMaxCount: BigNumberish, assertion: RollupLib.AssertionStruct, expectedNodeHash: BytesLike, overrides?: CallOverrides): Promise<void>;
